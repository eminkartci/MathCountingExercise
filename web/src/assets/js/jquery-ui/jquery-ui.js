...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNames:["Ocak", "Şubat", "Mart", "Nisan", "Mayıs", "Haziran","Temmuz","Ağıstos","Eylül","Ekim","Kasım","Aralık" ], // Names of months for drop-down and formatting
		monthNamesShort: [ "Ocak", "Şub", "Mar", "Nis", "May", "Haz", "Tem", "Ağu", "Eyl", "Ek", "Kas", "Ara" ], // For formatting
		dayNames: [ "Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi" ], // For formatting
		dayNamesShort: [ "Pz", "Pzt", "Sl", "Çrş", "Prş", "Cm", "Cmt" ], // For formatting
		dayNamesMin: [ "Pz", "Pzt", "Sl", "Çrş", "Prş", "Cm", "Cmt" ], // Column headings for days starting at Sunday
