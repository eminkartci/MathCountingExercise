...
export let kiz_ismi    = ["Elif","Açelya","Elvan","Selen","Emin","Eda","Melis","Ceylin","Zeynep","Pelin","Özlem"]
export let erkek_ismi  = ["Can","Yiğit","Türkdoğan","Ferhat","Emir","Buğra","Eren","Ertuğrul","Deniz","Durmuş","Arda","Ali","Burak","Sidar","Ömer"]
