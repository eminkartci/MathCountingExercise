...
export  let yazim_kurallari = new Konu("0",turkce,"yazim-kurallari","Yazım Kuralları")
...
export let elektrik_manyetizma = new Konu("0",fizik,"elektrik-manyetizma","Elektrik - Manyetizma")
...
export  let katli_oranlar_kanunu = new Konu("0",kimya,"katli-oranlar-kanunu","Katlı Oranlar Kanunu")
...
export  let mitoz_bolunme = new Konu("0",biyoloji,"mitoz-bolunme","Mitoz Bölünme")
...
export  let ilk_turk_beylikleri = new Konu("0",tarih,"ilk-turk-beylikleri","İlk Türk Beylikleri")
