...
// export  let yazim_kurallari = new Konu(turkce,"Yazım Kuralları")
...
// export  let sabit_oranlar_kanunu = new Konu(kimya,"Sabit Oranlar Kanunu")
...
// export  let mitoz_bolunme = new Konu(biyoloji,"Mitoz Bölünme")
...
// export  let ilk_turk_beylikleri = new Konu(tarih,"İlk Türk Beylikleri")
...
// export  let kimya_sorusu        = new Soru(kimya,sabit_oranlar_kanunu)
